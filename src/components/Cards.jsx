...
//   return (
//     <div className="bg-gray-100  sm:px-6 lg:px-20">
      ...
      <div className="max-w-screen-xl  mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-10">
          {testimonials.map(({ name, role, company, image, text }) => (
            <div
              key={name}
              className="bg-white shadow-md p-4 rounded-lg h-full flex flex-col justify-between"
            >
              <div className="flex items-center space-x-4 mb-4">
                <img
                  src={image}
                ...
                <div>
                  <a href="/">
                    <h5 className="text-blue-500 font-bold text-lg sm:text-xl hover:underline">{name}</h5>
                  </a>
        ...
        <div className="flex justify-center mt-12">
          <button
            type="button"
            className="text-xl sm:text-2xl font-bold rounded-md px-8 sm:px-12 py-3 shadow-xl text-white"
            style={{ backgroundColor: "rgb(66, 133, 245)" }}
          >
            Start Training-Free >>
          </button>
