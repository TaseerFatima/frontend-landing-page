    ...
    <div className="flex flex-col min-h-screen bg-black">
      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <form onSubmit={handleSubmit} className="w-full max-w-md flex flex-col gap-4">
          ...
          <button onClick={() => window.location.href = "http://localhost:5000/auth/github"} className="w-full p-2 border border-gray-500 rounded-md bg-transparent text-white hover:bg-gray-700 inline-flex items-center justify-center gap-2"><i className="fab fa-github"></i>
            Login with GitHub
          </button>
